...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/actions/docs/01-installation.md"
title: 安装
---

**Action 包已经在[面板中](../panels/installation)预装了**？那你可以跳过此安装。本教程适合于在自定义 TALL 栈(Tailwind, Alpine, Livewire, Laravel)应用中使用表单构造器。
