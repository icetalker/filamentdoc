...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/support/docs/08-plugins/01-getting-started.md"
...
1. [Filament Asset Management](/docs/en/3.x/support/assets)
2. [Panel Plugin Development](/docs/en/3.x/panels/plugins)
3. [Icon Management](/docs/en/3.x/support/icons)
4. [Colors Management](/docs/en/3.x/support/colors)
5. [Style Customization](/docs/en/3.x/support/style-customization)
