...
> The livewire team have done a great job in making it stable, but it was a complete rewrite of Livewire v2. You may encounter issuses, so we recommend testing your application thoroughly before using Filament v3 in production.
