...
Filament bundles a large selection of [table columns](../tables/columns/getting-started##available-columns). Let's use a simple [text column](../tables/columns/text) for all the fields in the `patients` table:
