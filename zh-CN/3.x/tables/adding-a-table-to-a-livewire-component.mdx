...
关联表在面板中以["关联管理器"](../panels/resources/relation-managers#创建关联管理器)的方式使用。大部分关联管理器的特性也能用在关联表中。比如，[attaching 和 detaching](../panels/resources/relation-managers#attaching-and-detaching-records) 和 [associating 和 dissociating](../panels/resources/relation-managers#associating-and-dissociating-records) Action。
