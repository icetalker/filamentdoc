...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/support/docs/08-plugins/02-build-a-panel-plugin.md"
title: Build a panel plugin
---

## Preface

Please read the docs on [panel plugin development](/docs/en/3.x/panels/plugins) and the [getting started guide](/docs/en/3.x/support/plugins/getting-started) before continuing.
...
First, we'll create the plugin using the steps outlined in the [getting started guide](/docs/en/3.x/support/plugins/getting-started#creating-a-plugin).
