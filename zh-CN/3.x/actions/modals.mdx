...
使用 `modalWidth()` 方法，你可以修改模态框宽度。宽度选项对应于 [Tailwind 的 max-width 大小](https://tailwindcss.com/docs/max-width)。可用选项包括 `xs`、`sm`、`md`、`lg`、`xl`、`2xl`、`3xl`、`4xl`、`5xl`、`6xl`、`7xl` 和 `screen`：
