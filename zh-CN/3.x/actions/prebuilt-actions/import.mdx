...
该特性使用了[批量队列作业](https://laravel.com/docs/queues#job-batching)及[数据库通知](../../notifications/database-notifications#overview)，因此你需要发布这些迁移到 Laravel 中。同时，也需要发布 Filament 用于存储导入数据的迁移表：
