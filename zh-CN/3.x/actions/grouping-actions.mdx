...
使用 `dropdownWidth()` 方法，可以为下拉菜单设置宽度。选项对应于 [Tailwind 的 max-width 大小](https://tailwindcss.com/docs/max-width)。选项包括 `ExtraSmall`、`Small`、`Medium`、`Large`、`ExtraLarge`、`TwoExtraLarge`、`ThreeExtraLarge`、`FourExtraLarge`、`FiveExtraLarge`、`SixExtraLarge` 和 `SevenExtraLarge`
