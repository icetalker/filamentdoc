...
图标默认大小是 `IconColumnSize::Large`，不过你可以将其自定义为 `IconColumnSize::ExtraSmall`、`IconColumnSize::Small`、`IconColumnSize::Medium` 、`IconColumnSize::ExtraLarge` 或 `IconColumnSize::ExtraExtraLarge`：
