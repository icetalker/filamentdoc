...
The Filament Panel Builder pre-installs the [Form Builder](/docs/en/3.x/forms/installation), [Table Builder](/docs/en/3.x/tables/installation), [Notifications](/docs/notifications/installation), [Actions](/docs/en/3.x/actions/installation), [Infolists](/docs/en/3.x/infolists/installation), and [Widgets](/docs/en/3.x/widgets/installation) packages. No other installation steps are required to use these packages within a panel.
