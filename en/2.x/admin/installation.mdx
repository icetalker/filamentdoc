...
This package is compatible with other Filament v2.x products. The [form builder](/docs/2.x/en/forms/installation), [table builder](/docs/2.x/en/tables/installation) and [notifications](/docs/2.x/en/notifications/installation) come pre-installed with the package, and no other installation steps are required to use them within the admin panel.
