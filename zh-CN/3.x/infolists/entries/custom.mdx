...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/infolists/docs/03-entries/08-custom.md"
title: 自定义 Entry
---
...
> 如果你只要创建一个只用一次的简单自定义 Entry，你可以使用 [View Entry](#view-entry) 来渲染任何自定义 Blade 文件。
