...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/support/docs/08-plugins/03-build-a-standalone-plugin.md"
...
We are using x-load to asynchronously load stylesheet, so it's only loaded when necessary. You can learn more about this in the [Core Concepts](/docs/en/3.x/support/assets#lazy-loading-css) section of the docs.
