...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/forms/docs/04-layout/01-getting-started.md"
title: 开始
---
...
布局组件类在 `Filament\Forms\Components` 命名空间下。他们和其他[表单字段]一起，存放在表单 Schema 内。
