...
所有的布局组件([Grid](../../forms/layout/grid#grid-component)、[Section](../../forms/layout/section), [Fieldset](../../forms/layout/fieldset) 等)都有一个 `relationship()` 方法。使用该方法时，在该布局内的所有字段会被保存到关联模型中，而非所有者的模型： 
