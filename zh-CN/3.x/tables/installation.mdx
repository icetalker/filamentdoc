...
githubUrl: "https://github.com/filamentphp/filament/edit/3.x/packages/tables/docs/01-installation.md"
title: 安装
---

**表格构造器已经在[面板构造器](../panels/installation)中预装了。** 本教程适合于在自定义 TALL 栈(Tailwind, Alpine, Livewire, Laravel)应用中使用表单构造器。
